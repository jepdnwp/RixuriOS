...
xhci-profile-test: | build
	$(HOST_CC) -std=c17 -Wall -Wextra -Werror -I. tests/xhci_profile_test.c kernel/usb/xhci_profile.c -o build/xhci_profile_test
