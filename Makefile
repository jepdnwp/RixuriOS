...
OBJ := kernel/boot.o kernel/main.o kernel/serial.o kernel/user_init_blob.o \
 ...
 kernel/storage/block.o kernel/storage/block_cache.o kernel/storage/nvme.o kernel/usb/xhci.o kernel/usb/hid.o kernel/time/rtc.o kernel/time/time.o kernel/power/power.o
