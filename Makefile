...
build/user_unistd.o: user/libc/src/unistd.c user/libc/include/unistd.h | build
	$(CC) $(USER_INIT_CFLAGS) -c $< -o $@
	build/user_libc.o: user/libc/src/libc.c user/libc/include/string.h user/libc/include/stdlib.h user/libc/include/errno.h user/libc/include/ctype.h user/libc/include/stdio.h user/libc/include/fcntl.h user/libc/include/dirent.h user/libc/include/sys/stat.h user/libc/include/time.h | build
	$(CC) $(USER_INIT_CFLAGS) -c $< -o $@
