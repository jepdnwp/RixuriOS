...
OBJ := kernel/boot.o kernel/main.o kernel/serial.o \
 ...
 kernel/mm/pmm.o kernel/mm/vmm.o kernel/mm/uaccess.o kernel/mm/heap.o kernel/sync/lock.o kernel/sync/waitqueue.o kernel/storage/block.o kernel/storage/nvme.o
