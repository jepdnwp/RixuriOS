...
IMAGE = ROOT / "build" / "rixfs-pipeclose.img"
ESP = ROOT / "build" / "uefi" / "esp-pipeclose"
LOG = ROOT / "build" / "qemu-pipe-close.log"
...
print("qemu pipe close/wakeup test: PASS")
