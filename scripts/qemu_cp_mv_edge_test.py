...
for marker in (b"metadata-source=PASS", b"chown-policy=PASS", b"rename-inode=PASS", b"rename-overwrite=PASS", b"rename-failure-safe=PASS", b"rename-crossdir=PASS", b"rename-cross-overwrite=PASS", b"rename-roundtrip=PASS",
