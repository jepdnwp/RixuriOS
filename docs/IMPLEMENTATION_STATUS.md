...
- Shell: Phase 18 bounded lexer/parser frontend and callback-driven variable expansion are implemented and host-tested for quoting, escaping, comments, pipelines, logical/sequential/background operators and input/output/append redirections; execution, command substitution and interactive history remain open.
