...
Phase 15 continuation: control/bulk/interrupt transfer correctness, descriptor enumeration, HID keyboard/mouse transfer delivery, disconnect/hotplug handling, and negative-path tests.
