...
- TTY: canonical/raw input, line readiness, echo/output queues, foreground process-group state and PTY master/slave byte/line flow are implemented and host-tested; signals and terminal parser remain open.
