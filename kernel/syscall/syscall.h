...
/* File metadata extensions: fstat operates on an open descriptor and lstat
 * deliberately does not follow the final symbolic-link component. */
#define RIX_SYS_FSTAT 148
#define RIX_SYS_LSTAT 149
#define RIX_SYS_ACCESS 150
#define RIX_SYS_SHUTDOWN 151
#define RIX_SYS_SETSOCKOPT 152
