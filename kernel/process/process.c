...
static rix_process_t table[RIX_PROCESS_MAX];static uint32_t supplementary_groups[RIX_PROCESS_MAX][RIX_PROCESS_GROUP_MAX];static uint32_t supplementary_counts[RIX_PROCESS_MAX];static uint32_t real_uids[RIX_PROCESS_MAX],saved_uids[RIX_PROCESS_MAX],real_gids[RIX_PROCESS_MAX],saved_gids[RIX_PROCESS_MAX];static rix_session_info_t sessions[RIX_SESSION_MAX];static pid_t current_pid;static pid_t next_pid;static size_t live_count;
