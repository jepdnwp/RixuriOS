...
#define RIX_SHELL_PIPE_OUTPUT_MARKER (RIX_SHELL_MAX_COMMANDS + 1u)
#define RIX_SHELL_PIPE_INPUT_MARKER (RIX_SHELL_MAX_COMMANDS + 2u)
...
typedef int (*rix_shell_indexed_pipeline_runner_t)(const rix_shell_command_t *command,
